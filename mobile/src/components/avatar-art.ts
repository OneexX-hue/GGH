// Аватары-силуэты из Secret Chat UI Kit (docs/LICENSING.md, «Secret Chat
// UI Kit») — сырой SVG-XML, встроен как строки (а не файл-ассет), т.к.
// Expo/Metro без react-native-svg-transformer не импортирует .svg как
// текст. Рендерится через react-native-svg SvgXml, см. AvatarSilhouette.tsx.
// Те же файлы, что и web-admin/public/chat-kit/avatars/*.svg.

export const AVATAR_SINGLE_1 = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64" height="64">
  <defs>
    <clipPath id="ca"><circle cx="32" cy="32" r="32"/></clipPath>
    <radialGradient id="bga" cx="38%" cy="26%" r="82%">
      <stop offset="0" stop-color="#3E4751"/><stop offset=".42" stop-color="#141A21"/><stop offset="1" stop-color="#05080B"/>
    </radialGradient>
    <linearGradient id="rima" x1="0" y1="0" x2="1" y2="1">
    ...
    <linearGradient id="tora" x1=".2" y1="0" x2=".8" y2="1">
      <stop offset="0" stop-color="#2C343C"/><stop offset="1" stop-color="#080C10"/>
    </linearGradient>
  </defs>
  <g clip-path="url(#ca)">
    <rect width="64" height="64" fill="url(#bga)"/>
    <path d="M12 64c1.5-13 9-19.5 20-19.5S50.5 51 52 64Z" fill="url(#tora)"/>
    ...
    <circle cx="32" cy="32" r="31.5" fill="none" stroke="#FFFFFF" stroke-opacity=".10"/>
  </g>
</svg>`;

export const AVATAR_SINGLE_2 = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64" height="64">
  <defs>
    <clipPath id="ce"><circle cx="32" cy="32" r="32"/></clipPath>
    <radialGradient id="bge" cx="38%" cy="26%" r="82%">
      <stop offset="0" stop-color="#3E4751"/><stop offset=".42" stop-color="#141A21"/><stop offset="1" stop-color="#05080B"/>
    </radialGradient>
    <linearGradient id="rime" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0" stop-color="#C4D0DA" stop-opacity=".78"/><stop offset=".55" stop-color="#49535C" stop-opacity=".38"/><stop offset="1" stop-color="#0A0F14" stop-opacity="0"/>
    </linearGradient>
    <linearGradient id="tore" x1=".2" y1="0" x2=".8" y2="1">
      <stop offset="0" stop-color="#2C343C"/><stop offset="1" stop-color="#080C10"/>
    </linearGradient>
  </defs>
  <g clip-path="url(#ce)">
    <rect width="64" height="64" fill="url(#bge)"/>
    <path d="M11 64c1.8-12.4 9.6-18.6 21-18.6S51.2 51.6 53 64Z" fill="url(#tore)"/>
...
export const AVATAR_SINGLE_3 = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64" height="64">
  <defs>
    <clipPath id="cd"><circle cx="32" cy="32" r="32"/></clipPath>
    <radialGradient id="bgd" cx="38%" cy="26%" r="82%">
      <stop offset="0" stop-color="#3E4751"/><stop offset=".42" stop-color="#141A21"/><stop offset="1" stop-color="#05080B"/>
    </radialGradient>
    <linearGradient id="rimd" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0" stop-color="#C4D0DA" stop-opacity=".78"/><stop offset=".55" stop-color="#49535C" stop-opacity=".38"/><stop offset="1" stop-color="#0A0F14" stop-opacity="0"/>
    </linearGradient>
    <linearGradient id="tord" x1=".2" y1="0" x2=".8" y2="1">
      <stop offset="0" stop-color="#2C343C"/><stop offset="1" stop-color="#080C10"/>
    </linearGradient>
  </defs>
  <g clip-path="url(#cd)">
    <rect width="64" height="64" fill="url(#bgd)"/>
    <path d="M10 64c2-12.6 10-19 22-19s20 6.4 22 19Z" fill="url(#tord)"/>
...
export const AVATAR_GROUP = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64" height="64">
  <defs>
    <clipPath id="cg"><circle cx="32" cy="32" r="32"/></clipPath>
    <radialGradient id="bgg" cx="38%" cy="26%" r="82%">
      <stop offset="0" stop-color="#3E4751"/><stop offset=".42" stop-color="#141A21"/><stop offset="1" stop-color="#05080B"/>
    </radialGradient>
    <linearGradient id="rimg" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0" stop-color="#C4D0DA" stop-opacity=".78"/><stop offset=".55" stop-color="#49535C" stop-opacity=".38"/><stop offset="1" stop-color="#0A0F14" stop-opacity="0"/>
    </linearGradient>
    <linearGradient id="torg" x1=".2" y1="0" x2=".8" y2="1">
      <stop offset="0" stop-color="#2C343C"/><stop offset="1" stop-color="#080C10"/>
    </linearGradient>
  </defs>
  <g clip-path="url(#cg)">
    <rect width="64" height="64" fill="url(#bgg)"/>
    <g fill="#080D12" stroke="#C7D4DF" stroke-opacity=".22" stroke-width=".8">
...
export const AVATAR_PORTRAIT = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="128" height="128">
  <defs>
...
export const SINGLE_VARIANTS = [AVATAR_SINGLE_1, AVATAR_SINGLE_2, AVATAR_SINGLE_3];
